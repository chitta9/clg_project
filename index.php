<?php
  ...
  if(isset($_POST['login'])){
    ...
    if(mysqli_num_rows($query_run)){
      ...
      echo "<script>alert('Please Enter correct admin email id and password');
      ...
      <div class="row">
        <div class="col-md-4 m-auto block">
          ...
          <form action="index.php" method="post">
            ...
            <button class="btn btn-primary" style="float:right" type="button" onclick="window.location.href='../index.php'" name="admin">USER LOGIN</button>
          </form>
